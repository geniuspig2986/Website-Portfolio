            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {PROJECTS.map((p) => (
                    <Link
                        ...
                        className="group flex flex-col gap-3 p-6 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white/60 dark:bg-zinc-900/40 backdrop-blur-md hover:border-cyan-500/60 dark:hover:border-cyan-500/50 transition-colors"
                    >
